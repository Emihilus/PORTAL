 ...
 */
final class Version20210909100804 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, auction_id INT DEFAULT NULL, by_user_id INT NOT NULL, reply_to_id INT DEFAULT NULL, content LONGTEXT NOT NULL, created_at DATETIME NOT NULL, modified_at DATETIME NOT NULL, value INT DEFAULT NULL, notification_handled TINYINT(1) NOT NULL, INDEX IDX_9474526C57B8F0DE (auction_id), INDEX IDX_9474526CDC9C2434 (by_user_id), INDEX IDX_9474526CFFDF7169 (reply_to_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
