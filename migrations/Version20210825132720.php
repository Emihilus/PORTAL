 ...
 */
final class Version20210825132720 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE auctions (id INT AUTO_INCREMENT NOT NULL, by_user_id INT NOT NULL, liked_by_user_id INT DEFAULT NULL, title VARCHAR(30) NOT NULL, created_at DATETIME NOT NULL, ends_at DATETIME NOT NULL, description TEXT DEFAULT NULL, INDEX IDX_72D6E900DC9C2434 (by_user_id), INDEX IDX_72D6E90069A9A8C8 (liked_by_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE auctions ADD CONSTRAINT FK_72D6E90069A9A8C8 FOREIGN KEY (liked_by_user_id) REFERENCES users (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE auctions DROP FOREIGN KEY FK_72D6E90069A9A8C8');
